...
class SamClickSegmenter implements ClickSegmenter {
  ...
  Future<void> _ensureLoaded() async {
    ...
    GarmentOnnx.loadSession('sam_enc', encoder.path);
    GarmentOnnx.loadSession('sam_dec', decoder.path);
    _loaded = true;
  }
  ...
  Future<void> dispose() async {
    if (_loaded) {
      GarmentOnnx.closeSession('sam_enc');
      GarmentOnnx.closeSession('sam_dec');
      _loaded = false;
    }
    _embedding = null;
  }
